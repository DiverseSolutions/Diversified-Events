      ...
      <div>
        ...
        <div>
          ...
          <div className='border rounded-2xl my-5 p-6'>
            <span className='font-semibold text-xl'>Details</span> <br />
            <div className='mt-2'>
              <div className='flex items-center gap-2'>
                ...
                <span className='text-sm'>74 people joined</span>
              </div>
              <div className='flex items-center gap-2 pt-2'>
                ...
                <span className='text-sm'>Online with google meet</span>
              </div>
              <div className='flex items-center gap-2 pt-2'>
                <svg width='1.5em' height='1.5em' viewBox='0 0 24 24'>
                  <path
                ...
                <span className='text-sm'>Purchase for 0.008 ETH</span>
              </div>
            </div>
            <div className='pt-2'>
              <span className='font-semibold text-xl'>Introduction</span> <br />
